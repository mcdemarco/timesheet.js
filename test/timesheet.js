...
suite('Timesheet', function() {
  test('Calculation', function(done) {
    ...
    assert.equal(12,  (TS.createBubble(60, 2012, TS.parseDate('2002/04'), TS.parseDate('2003/04'))).getMonths());

    assert.equal(24,  (TS.createBubble(60, 2012, TS.parseDate('2002/04'), TS.parseDate('2004/04'))).getMonths());
